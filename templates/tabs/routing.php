...
if ( class_exists( '\\WPMind\\Modules\\Analytics\\AnalyticsManager' ) ) {
	$analytics       = \WPMind\Modules\Analytics\AnalyticsManager::instance();
...
<div class="wpmind-routing-panel">
	...
	<div class="wpmind-routing-grid">
		...
		<div class="wpmind-routing-left">
			<div class="wpmind-routing-section">
				...
				<div class="wpmind-strategy-list">
					<?php
					foreach ( $available_strategies as $strategy_name => $strategy_info ) :
		...
		<div class="wpmind-routing-right">
			<!-- 推荐 Provider 卡片 -->
			<?php
			if ( ! empty( $routing_status['recommended'] ) ) :
	...
	<div class="wpmind-routing-section wpmind-routing-ranking">
		...
		<div class="wpmind-routing-scores" id="wpmind-routing-scores">
			<?php
			foreach ( $routing_status['provider_scores'] as $provider_id => $score_data ) :
