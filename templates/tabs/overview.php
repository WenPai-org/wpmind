...
<div class="wpmind-overview">
	...
	<div class="wpmind-overview-hero">
		...
		<p class="wpmind-overview-hero-subtitle">
		<?php
		esc_html_e(
		...
		<p class="wpmind-overview-hero-meta">
			...
			&middot; <?php echo esc_html( count( $providers ) ); ?>
			<?php
			esc_html_e(
				'个 Provider',
				'wpmind',
			...
			?>
			&middot; <?php echo esc_html( $active_count ); ?>/
			<?php
			echo esc_html(
				count( $modules ),
			);
	...
	<?php esc_html_e( '缓存命中率', 'wpmind' ); ?>
		...
		<div class="wpmind-overview-hero-actions">
			<a href="#services" class="wpmind-overview-hero-btn wpmind-overview-hero-btn--primary wpmind-tab-link" data-tab-link="services">
			<?php
			esc_html_e(
				'添加 Provider',
				'wpmind',
			...
			<a href="#analytics" class="wpmind-overview-hero-btn wpmind-overview-hero-btn--secondary wpmind-tab-link" data-tab-link="analytics">
			<?php
			esc_html_e(
				'Token 统计',
				'wpmind',
	...
	<div class="wpmind-overview-stats">
		<div class="wpmind-overview-stat">
			...
			<div class="wpmind-overview-stat-body">
				<span class="wpmind-overview-stat-value">
				<?php
				echo esc_html(
				...
				<span class="wpmind-overview-stat-label">
				<?php
				esc_html_e(
					'今日请求',
					'wpmind',
		...
		<div class="wpmind-overview-stat">
			...
			<div class="wpmind-overview-stat-body">
				...
				?>
	<span class="wpmind-overview-stat-sub">/
	<?php
	echo esc_html(
		count( $providers ),
	);
	...
	<div class="wpmind-overview-grid">
		...
		<div class="wpmind-overview-card">
			<div class="wpmind-overview-card-header">
				<h3><span class="dashicons ri-server-line"></span>
				<?php
				esc_html_e(
					'Provider 状态',
					'wpmind',
				...
				<a href="#services" class="wpmind-overview-card-link wpmind-tab-link" data-tab-link="services">
				<?php
				esc_html_e(
					'管理',
					'wpmind',
	...
	&rarr;</a>
			...
			<div class="wpmind-overview-card-body">
				<?php if ( empty( $providers ) ) : ?>
					<div class="wpmind-overview-empty-state">
						...
						<p class="wpmind-overview-empty-text">
						<?php
						esc_html_e(
							'还没有配置 Provider',
							'wpmind',
						...
						<a href="#services" class="wpmind-overview-empty-action wpmind-tab-link" data-tab-link="services">
						<?php
						esc_html_e(
							'去配置',
							'wpmind',
		...
		" style="color: <?php echo esc_attr( $color ); ?>"></span>
							<span class="wpmind-overview-provider-name">
							<?php
							echo esc_html(
								$name,
							);
		...
		<div class="wpmind-overview-card">
			<div class="wpmind-overview-card-header">
				<h3><span class="dashicons ri-puzzle-line"></span>
				<?php
				esc_html_e(
					'模块状态',
					'wpmind',
				...
				<a href="#modules" class="wpmind-overview-card-link wpmind-tab-link" data-tab-link="modules">
				<?php
				esc_html_e(
					'管理',
					'wpmind',
			...
			<div class="wpmind-overview-card-body">
				<div class="wpmind-overview-module-list">
					...
					<div class="wpmind-overview-module-item">
						...
						?>
		" style="color: <?php echo esc_attr( $color ); ?>"></span>
						<span class="wpmind-overview-module-name">
						<?php
	...
	<div class="wpmind-overview-grid">
		...
		<div class="wpmind-overview-card">
			<div class="wpmind-overview-card-header">
				<h3><span class="dashicons ri-bar-chart-grouped-line"></span>
				<?php
				esc_html_e(
					'本月摘要',
					'wpmind',
				...
				<div class="wpmind-overview-summary-grid">
					<div class="wpmind-overview-summary-cell">
						...
						<div class="wpmind-overview-summary-text">
							<span class="wpmind-overview-summary-value">
							<?php
							echo esc_html(
								$top_model,
							);
							...
							<span class="wpmind-overview-summary-label">
							<?php
							esc_html_e(
								'最常用模型',
								'wpmind',
		...
		<div class="wpmind-overview-card">
			<div class="wpmind-overview-card-header">
				<h3><span class="dashicons ri-pulse-line"></span>
				<?php
				esc_html_e(
					'最近活动',
					'wpmind',
				...
				<?php if ( class_exists( 'WPMind\\Modules\\Analytics\\AnalyticsManager' ) ) : ?>
					<a href="#analytics" class="wpmind-overview-card-link wpmind-tab-link" data-tab-link="analytics">
					<?php
					esc_html_e(
						'查看全部',
						'wpmind',
			...
			<div class="wpmind-overview-card-body">
				<?php if ( empty( $recent_history ) ) : ?>
					<div class="wpmind-overview-empty-state">
						...
						<p class="wpmind-overview-empty-hint">
						<?php
						esc_html_e(
				...
				<?php else : ?>
					<div class="wpmind-overview-activity-list">
						...
						<div class="wpmind-overview-activity-item">
							<span class="wpmind-overview-activity-time">
							<?php
							echo esc_html(
								$time_ago,
							);
							...
							<span class="wpmind-overview-activity-model">
							<?php
							echo esc_html(
								$model,
							);
							...
							<span class="wpmind-overview-activity-meta">
								<span class="wpmind-overview-activity-tokens">
								<?php
								echo esc_html(
								...
								<?php if ( $latency > 0 ) : ?>
									<span class="wpmind-overview-activity-latency">
									<?php
									echo esc_html(
										$latency . 'ms',
									);
	...
	<div class="wpmind-overview-grid">
		...
		<div class="wpmind-overview-card">
			<div class="wpmind-overview-card-header">
				<h3><span class="dashicons ri-question-line"></span>
				<?php
				esc_html_e(
					'帮助文档',
					'wpmind',
		...
		<div class="wpmind-overview-card">
			<div class="wpmind-overview-card-header">
				<h3><span class="dashicons ri-links-line"></span>
				<?php
				esc_html_e(
					'浏览更多',
					'wpmind',
	...
	<p class="wpmind-overview-footer">WPMind v
	<?php
	echo esc_html(
		WPMIND_VERSION,
	);
