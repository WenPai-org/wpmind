...
<div class="wpmind-auto-meta-panel">
	...
	<!-- Sub-tab Navigation -->
	<div class="wpmind-mi-subtabs wpmind-am-subtabs">
		<button type="button" class="wpmind-mi-subtab active" data-tab="am-settings">
			<span class="dashicons ri-settings-3-line"></span>
			<?php esc_html_e( '功能开关', 'wpmind' ); ?>
		</button>
		<button type="button" class="wpmind-mi-subtab" data-tab="am-manual">
	...
	<!-- ========== Tab: Settings ========== -->
	<div class="wpmind-mi-tab-panel active" data-panel="am-settings">
		...
		<div class="wpmind-geo-option wpmind-am-post-types-row">
	...
	<!-- ========== Tab: Manual Generate ========== -->
	<div class="wpmind-mi-tab-panel" data-panel="am-manual">
